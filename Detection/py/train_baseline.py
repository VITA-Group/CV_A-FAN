...
def _train(dataset_name: str, backbone_name: str, path_to_data_dir: str, path_to_checkpoints_dir: str, path_to_resuming_checkpoint: Optional[str], args):
    print("Training Baseline ! DATASET:[{}] DIR:[{}]".format(dataset_name, path_to_data_dir))
...
if __name__ == '__main__':
    def main():
        ...
        path_to_checkpoints_dir = os.path.join(path_to_outputs_dir, 'checkpoints-{:s}-{:s}_baseline'.format(
