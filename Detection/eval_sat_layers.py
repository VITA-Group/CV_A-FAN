...
def _eval(path_to_checkpoint: str, dataset_name: str, backbone_name: str, path_to_data_dir: str, path_to_results_dir: str, args):
    ...
    mean_ap, detail = evaluator.sat_layer_evaluate(model, args)
...
if __name__ == '__main__':
    def main():
        ...
        parser.add_argument('--pertub_idx', help='index of perturb layers', default=0, type=int)
        parser.add_argument('--sat_layer', help='index of perturb layers', default=1, type=int)
        ...
        print("SAT LAYER:[{}] MIX:[{}]".format(args.sat_layer, args.mix))
