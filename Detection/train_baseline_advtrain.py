...
def _train(dataset_name: str, backbone_name: str, path_to_data_dir: str, path_to_checkpoints_dir: str, path_to_resuming_checkpoint: Optional[str], args):
    ...
    while not should_stop:
        for _, (_, image_batch, _, bboxes_batch, labels_batch) in enumerate(dataloader):
            ...
            adv_input_dict = {'x': adv_image_batch, "adv": None, 'out_idx': -1, 'flag':'clean'}
            ...
            loss = attack_algo.compute_loss(anchor_objectness_losses1, anchor_transformer_losses1, proposal_class_losses1, proposal_transformer_losses1)
...
if __name__ == '__main__':
    def main():
        ...
        exp_name = "s" + str(args.steps) +  "g" + str(args.gamma) + "e" + str(args.eps)
        ...
        print("EXP: Dataset:[{}] ADV Training Step:[{}] Gamma:[{}] Eps:[{}] Randinit:[{}] Clip:[{}]"
            .format(args.dataset, args.steps, args.gamma, args.eps, args.randinit, args.clip))
        print("-" * 100)
