...
def _train(dataset_name: str, backbone_name: str, path_to_data_dir: str, path_to_checkpoints_dir: str, path_to_resuming_checkpoint: Optional[str], args):
    ...
    for iters, (_, image_batch, _, bboxes_batch, labels_batch) in enumerate(dataloader):
        ...
        adv_list_layer1 = [i.squeeze()[5].cpu().detach().numpy() for i in adv_list_layer1]
        ...
        print(iters)
        attack_algo.img_save(image_batch[0], save_name='img3/img{}.png'.format(iters))
        ...
        #     attack_algo.feature_map_save(j, save_name='img2/img{}_layer2_sat{}.png'.format(iters, i))
        # print("finish 2")

        # for i, j in enumerate(adv_list_layer3):
        #     attack_algo.feature_map_save(j, save_name='img2/img{}_layer3_sat{}.png'.format(iters, i))
        # print("finish 3")
