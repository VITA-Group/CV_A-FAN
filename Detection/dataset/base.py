...
class Base(torch.utils.data.dataset.Dataset):
    ...
    OPTIONS = ['voc2007', 'voc20072012','coco2017', 'voc2007-cat-dog', 'coco2017-person', 'coco2017-car', 'coco2017-animal']
    ...
    def from_name(name: str) -> Type['Base']:
        if name == 'voc2007':
            ...
            return VOC2007
        elif name == 'voc20072012':
            from dataset.voc20072012 import VOC20072012
            return VOC20072012
        elif name == 'coco2017':
