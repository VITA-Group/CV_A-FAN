GPU=${1}
OUTPUTS_DIR=coco101final_ckpt04
...
# train
CUDA_VISIBLE_DEVICES=${GPU} python -u train_aug_final.py -s=coco2017 -b=resnet101 -o=${OUTPUTS_DIR} \
--image_min_side=800 \
--image_max_side=1333 \
...
# eval
CUDA_VISIBLE_DEVICES=${GPU} python eval.py -s=coco2017 -b=resnet101 \
--image_min_side=800 \
--image_max_side=1333 \
--anchor_sizes="[64, 128, 256, 512]" \
--rpn_post_nms_top_n=1000 \
${OUTPUTS_DIR}/ckpt-s1se_${LAYER}_sd_roi_g${GAMMA_se}e2_MIX${MASK}-coco2017-resnet101/model-180000.pth