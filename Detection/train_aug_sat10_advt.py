...
def _train(dataset_name: str, backbone_name: str, path_to_data_dir: str, path_to_checkpoints_dir: str, path_to_resuming_checkpoint: Optional[str], args):
    ...
    while not should_stop:
        for _, (_, image_batch, _, bboxes_batch, labels_batch) in enumerate(dataloader):
            ...
            adv_list[8] = attack_algo.mix_feature(feature_map, adv_list[8])
            adv_list[9] = attack_algo.mix_feature(feature_map, adv_list[9])
            ...
            adv_input_dict3  =  {'x': image_batch,     'adv': adv_list[3], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict4  =  {'x': image_batch,     'adv': adv_list[4], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict5  =  {'x': image_batch,     'adv': adv_list[5], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict6  =  {'x': image_batch,     'adv': adv_list[6], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict7  =  {'x': image_batch,     'adv': adv_list[7], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict8  =  {'x': image_batch,     'adv': adv_list[8], 'out_idx': 2, 'flag':'tail' }
            adv_input_dict9  =  {'x': image_batch,     'adv': adv_list[9], 'out_idx': 2, 'flag':'tail' }
