...
from backbone.resnet101_ori import resnet101_ori
import torchvision
...
class ResNet101(backbone.base.Base):
    ...
    def features(self) -> Tuple[nn.Module, nn.Module, int, int]:
        resnet101 = resnet101_ori(pretrained=self._pretrained)
        ...
        for parameters in [feature.parameters() for feature in [resnet101.conv1, resnet101.bn1, resnet101.relu, resnet101.maxpool, resnet101.layer1]]:
